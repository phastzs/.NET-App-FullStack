...
using BaiTap6_63131016.Models;

namespace BaiTap6_63131016.Controllers
{
    public class QuanTris_63131016Controller : Controller
    {
        private QLNV_63131016Entities db = new QLNV_63131016Entities();
        ...
        public ActionResult DangNhap(QuanTri qt)
        {
            if (ModelState.IsValid)
            {
                if (CheckUser(qt.Email, qt.Password))
                {
                    ...
                    return RedirectToAction("Index", "NhanViens_63131016/Index");
                }
                else
